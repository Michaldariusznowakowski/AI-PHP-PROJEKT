...
FOR %%x IN ("\Users\MX\Github\AI-PHP-PROJEKT\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=\Users\MX\Github\AI-PHP-PROJEKT\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=\Users\MX\Github\AI-PHP-PROJEKT\php\"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=\Users\MX\Github\AI-PHP-PROJEKT\php\php.exe"
GOTO :INSTALLED
